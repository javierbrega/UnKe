...
import { ArrowRight, QrCode, Users, Percent } from "lucide-react"
...
export function Hero() {
  ...
  return (
    ...
    >
      ...
      <div 
        className="absolute inset-0 opacity-15 animate-in fade-in duration-[2000ms]"
        style={{
      ...
      <div 
        ...
        style={{
          backgroundImage: 'radial-gradient(circle, #C8FF00 2px, transparent 2px)',
          backgroundSize: '50px 50px',
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="inline-flex items-center gap-2 bg-neutral-900/80 backdrop-blur border border-neutral-800 rounded-full px-4 py-2 mb-8">
            ...
            <span className="text-sm text-neutral-300">+100 comercios ya conectados</span>
          </div>
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight text-white leading-[1.1] mb-6">
            La red de comercios
            <br />
            <span className="text-[#C8FF00]">que va a transformar Latinoamérica.</span>
          </h1>

          {/* Subtítulo */}
          <p className="text-lg md:text-xl text-neutral-400 max-w-2xl mx-auto mb-10 leading-relaxed">
            "La evolución digital de tu comercio comienza aquí."
               UnKe conecta tu local con el mundo digital a través de soluciones inteligentes
               de gestión y presencia online.
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16">
            ...
            <a
              ...
              className={cn(
                ...
                "border-neutral-700 text-white hover:bg-neutral-900 hover:text-[#C8FF00] font-medium px-8 py-6 text-base w-full sm:w-auto transition-all"
              )}
            >
              ¿Sos comercio? Sumate
            </a>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-3xl mx-auto">
            <div className="flex items-center gap-3 justify-center sm:justify-start text-neutral-400">
              <div className="w-10 h-10 rounded-lg bg-neutral-900 border border-neutral-800 flex items-center justify-center flex-shrink-0">
                <QrCode className="h-5 w-5 text-[#C8FF00]" />
              </div>
              <div className="text-left">
                <p className="text-white font-semibold text-sm">Escaneá el QR</p>
                <p className="text-xs text-neutral-500">De cualquier comercio</p>
              </div>
            </div>
            <div className="flex items-center gap-3 justify-center sm:justify-start text-neutral-400">
              <div className="w-10 h-10 rounded-lg bg-neutral-900 border border-neutral-800 flex items-center justify-center flex-shrink-0">
              ...
              <div className="text-left">
                <p className="text-white font-semibold text-sm">Suscribite</p>
                <p className="text-xs text-neutral-500">Accedé a la red</p>
              </div>
            </div>
            <div className="flex items-center gap-3 justify-center sm:justify-start text-neutral-400">
              <div className="w-10 h-10 rounded-lg bg-neutral-900 border border-neutral-800 flex items-center justify-center flex-shrink-0">
              ...
              <div className="text-left">
                <p className="text-white font-semibold text-sm">Ahorrá</p>
                <p className="text-xs text-neutral-500">En todos los rubros</p>
              </div>
            </div>
          </div>
        </div>
